...
/**
 * CountdownCard — inline, single row
 * No card border, just text. Used inline next to the live status.
 */
  ...
  return (
    <span className="inline-flex items-center gap-1.5 text-xs text-slate-300">
      ...
      <span className="font-display font-bold tabular-nums text-white tracking-wider">
        {time.days > 0 && <>{String(time.days).padStart(2, '0')}<span className="text-slate-500 text-[10px] ml-0.5">d</span> </>}
