 ...
 * Same column width as the page content so brand and content align.
 */
export default function Header({ onAdminClick }) {
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto px-5 sm:px-7 py-3 flex items-center justify-between gap-3">
